**Overview**
This project applies Modern Portfolio Theory (MPT) to construct an optimal portfolio by balancing risk and return using historical stock data. The model identifies the asset allocation that maximizes the Sharpe Ratio and visualizes the Efficient Frontier.
